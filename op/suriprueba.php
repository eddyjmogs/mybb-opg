...
// define("IN_MYBB", 1);
// //                     nombre del php (Tener en cuenta que considera las mayus y mins)
// define('THIS_SCRIPT', 'suriprueba.php');

// require_once "./../global.php";

// //                                  nombre del template. El template es lo de op_xxx o op_staff_xxx. que se pone _ y no / para la ruta
// eval("\$page = \"".$templates->get("op_suriprueba")."\";");
// output_page($page);
